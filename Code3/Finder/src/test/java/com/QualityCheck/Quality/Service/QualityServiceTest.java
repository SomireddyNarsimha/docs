...
class QualityServiceTest {
    ...
    void testFetchLatestRecord() {
        ...
        Records mockRecord = new Records(1L, LocalDateTime.now().toString(), 7.2, 0.3, 200.0, 150.0, 100.0);
    ...
    void testCheckWaterQuality_Safe() {
        ...
        Records safeRecord = new Records(2L, LocalDateTime.now().toString(), 7.0, 0.5, 100.0, 200.0, 150.0);
    ...
    void testCheckWaterQuality_NotSafe() {
        ...
        Records unsafeRecord = new Records(3L, LocalDateTime.now().toString(), 9.0, 0.5, 400.0, 500.0, 300.0);
