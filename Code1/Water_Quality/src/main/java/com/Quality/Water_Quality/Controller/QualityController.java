...
public class QualityController {
        ...
        while (isRunning.get()) {
            try {
                ...
                if (latestRecord != null) {
                    ProcessedRecords isSafe = qualityService.checkWaterQuality(latestRecord);
    ...
    public Records getAll(){
        return qualityService.getAllRecords();
    }
}
