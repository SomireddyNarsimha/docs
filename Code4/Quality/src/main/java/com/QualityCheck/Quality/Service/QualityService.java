...
public class QualityService {
    private static final String MONITOR_SERVICE_URL = "http://localhost:8093/monitor/latest";
    private static final String ALL_RECORDS_URL = "http://localhost:8093/monitor/all";
    ...
    public QualityRecord checkWaterQuality(Records record) {
       ...
       // repo.save(record);
        ...
        if(!repo.existsById(record.getId())) {
            repo.save(qd);
            return qd;
        }
